        ...
        if chat['last_message']['author_object_guid'] in admins:
            ...
            if 'reply_to_message_id' in msg_data.keys():
                ...
                if not msg_data['author_object_guid'] in admins:
                    ...
                    bot.sendMessage(chat['object_guid'], 'کاربر سیکتیر شد @okowita 🎃' , chat['last_message']['message_id'])
                    return True
        return False
    except:
        print('server ban bug')
...
def get_leaved(text,chat,bot):
    try:
        ...
        send_text = 'karbar dar tarikh ' + date + ' az groh left dad @okowita 😶'   
...
g_usvl = ''
test_usvl = ''
auth = "mlabftsqjgfodjglqvofitwecsqjehak"
#توکن
bot = Bot(auth)
list_message_seened = []
...
#شروع متون
                            ...
                            if text == 'چنل' or text == 'پشتیبانی':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], '🔹- user support @okowita',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == 'امیر' or text == 'منجی' or text == 'سازنده' or text == 'سازندت کیه' or text == 'سازندت کیه؟':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], '@okowita',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
...
#اتمام متون
                            ...
                            if text == 'تست' or text == 'test' or text == '!test' or text == '/test' or text == '/Test' or text == '!Test':
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], '@okowita on',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                                ...
                                try:
                                    ...
                                    if not guid in admins and chat['last_message']['author_object_guid'] in admins:
                                        ...
                                        bot.sendMessage(chat['object_guid'], 'کاربر به همراه ایدی سیکتیر شد @okowita 👺' , chat['last_message']['message_id'])
                                except:
                                    print('ban bug')
                                ...
                                try:
                                    ...
                                    bot.sendMessage(chat['object_guid'], 'رفیقمون اضافه شود @okowita 👺' , chat['last_message']['message_id'])                         
                                except:
                                ...
                                tawd6.start()
                            elif text.startswith('/danpic') or text.startswith('دانش پ'):
